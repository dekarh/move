...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cmbParsingType = QtWidgets.QComboBox(self.frImportInf)
        self.cmbParsingType.setObjectName("cmbParsingType")
        self.verticalLayout_11.addWidget(self.cmbParsingType)
        ...
        self.frDelDoublesPhones = QtWidgets.QFrame(self.frame_7)
        self.frDelDoublesPhones.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frDelDoublesPhones.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frDelDoublesPhones.setObjectName("frDelDoublesPhones")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.frDelDoublesPhones)
        self.gridLayout_2.setContentsMargins(-1, 0, -1, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem6, 1, 1, 1, 1)
        self.pbDelDoubles = QtWidgets.QPushButton(self.frDelDoublesPhones)
        self.pbDelDoubles.setMinimumSize(QtCore.QSize(100, 0))
        self.pbDelDoubles.setObjectName("pbDelDoubles")
        self.gridLayout_2.addWidget(self.pbDelDoubles, 1, 0, 1, 1)
        self.pbDelDoubles2 = QtWidgets.QPushButton(self.frDelDoublesPhones)
        self.pbDelDoubles2.setMinimumSize(QtCore.QSize(100, 0))
        self.pbDelDoubles2.setObjectName("pbDelDoubles2")
        self.gridLayout_2.addWidget(self.pbDelDoubles2, 1, 4, 1, 1)
        self.clbDelDoublesPhones = QtWidgets.QCommandLinkButton(self.frDelDoublesPhones)
        self.clbDelDoublesPhones.setMaximumSize(QtCore.QSize(45, 45))
        self.clbDelDoublesPhones.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("phone-red.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clbDelDoublesPhones.setIcon(icon4)
        self.clbDelDoublesPhones.setIconSize(QtCore.QSize(30, 30))
        self.clbDelDoublesPhones.setObjectName("clbDelDoublesPhones")
        self.gridLayout_2.addWidget(self.clbDelDoublesPhones, 1, 2, 1, 1)
        spacerItem7 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem7, 1, 3, 1, 1)
        self.verticalLayout_3.addWidget(self.frDelDoublesPhones)
    ...
    def retranslateUi(self, Form):
        ...
        self.pbDelDoubles.setText(_translate("Form", "Удалить дубли"))
        self.pbDelDoubles2.setText(_translate("Form", "Удалить дубли"))
