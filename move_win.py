...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame_2 = QtWidgets.QFrame(self.frAll)
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.frame_2)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.lbDoubles = QtWidgets.QLabel(self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbDoubles.sizePolicy().hasHeightForWidth())
        self.lbDoubles.setSizePolicy(sizePolicy)
        self.lbDoubles.setText("")
        self.lbDoubles.setObjectName("lbDoubles")
        self.verticalLayout_9.addWidget(self.lbDoubles)
        self.frDateFrom = QtWidgets.QFrame(self.frame_2)
        ...
        self.frDateTo = QtWidgets.QFrame(self.frame_2)
