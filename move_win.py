...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame_7.setMaximumSize(QtCore.QSize(600, 480))
        ...
        self.chbArhiv = QtWidgets.QCheckBox(self.frame)
        self.chbArhiv.setObjectName("chbArhiv")
        self.verticalLayout.addWidget(self.chbArhiv)
        self.horizontalLayout_4.addWidget(self.frame)
        self.label = QtWidgets.QLabel(self.frAll)
        ...
        self.lSQLcl = QtWidgets.QLabel(self.frSQLcl)
        self.lSQLcl.setObjectName("lSQLcl")
        self.horizontalLayout_3.addWidget(self.lSQLcl)
        ...
        self.lSQLco = QtWidgets.QLabel(self.frSQLco)
        self.lSQLco.setObjectName("lSQLco")
        self.horizontalLayout_8.addWidget(self.lSQLco)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("move.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clbMove.setIcon(icon2)
    ...
    def retranslateUi(self, Form):
        ...
        self.leDir.setText(_translate("Form", "/home/da3/Загрузки/"))
        ...
        self.chbArhiv.setText(_translate("Form", "Поставить флаг \"Архивный\""))
        self.lSQLcl.setText(_translate("Form", "client     "))
        self.lSQLco.setText(_translate("Form", "contract"))
