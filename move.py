...
class MainWindow(MainWindowSlots):
    ...
    def connect_slots(self):
        ...
        self.pbDelDoubles.clicked.connect(self.click_pbDelDoubles)
        self.pbDelDoubles2.clicked.connect(self.click_pbDelDoubles)
        ...
        self.clbDelDoublesPhones.clicked.connect(self.click_clbDelDoublesPhones)
